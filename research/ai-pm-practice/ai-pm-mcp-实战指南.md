...
| 7 | [Model Context Protocol 官方介绍页（英文）](https://modelcontextprotocol.io/docs/getting-started/intro) | 外部 | MCP 官方权威定义，"AI 的 USB-C 接口"核心类比出处，简洁清晰适合初次了解 | ⭐⭐⭐ |
| 8 | [What Is MCP? A Product Manager's Guide to Model Context Protocol](https://www.institutepm.com/knowledge-hub/mcp-guide-for-product-managers) | 外部 | 专为产品经理撰写的 MCP 完整指南，覆盖架构、三大原语（Tools/Resources/Prompts）、安全模型及产品策略决策点 | ⭐⭐⭐ |
| 9 | [一文详解 MCP 与 Function Calling](https://www.woshipm.com/ai/6256593.html) | 外部 | 用"能力 vs 舞台"的比喻，面向非工程角色讲清 Function Calling 和 MCP 的分工协作关系，非常易懂 | ⭐⭐⭐ |
...
| 8 | [Skill / Prompt / MCP / SubAgent 选型指南](https://km.sankuai.com/collabpage/2749624013) | 学城 | 美团内部四种 AI 能力扩展方式的选型对比，含决策树和真实案例，适合 AI 产品经理快速定位方案 | ⭐⭐⭐ |
| 9 | [MCP for Enterprise Leaders: What You Need to Know](https://www.imagineworks.com/blog/mcp-enterprise-leaders) | 外部 | 面向企业决策者的 MCP 战略指南，覆盖安全治理、ROI 评估、采购决策框架，适合向管理层汇报 | ⭐⭐ |
| 10 | [MCP Enterprise Adoption Report 2025](https://ragwalla.com/mcp-enterprise-adoption-report-2025) | 外部 | 2025 年企业级 MCP 采用现状调研报告，含行业分布、落地障碍、ROI 数据，适合做市场判断参考 | ⭐⭐ |
| 11 | [When to Use MCP vs API vs Function Call](https://jamwithai.com/when-to-use-mcp-vs-api-vs-function-call) | 外部 | 用决策流程图对比 MCP、REST API、Function Calling 三种方案的适用场景，结论清晰可直接用于方案评审 | ⭐⭐⭐ |
| 12 | [外卖泛 B 端 MCP 规模化实践](https://km.sankuai.com/collabpage/2749624013) | 学城 | 美团外卖泛 B 端团队将 MCP 从 PoC 推向规模化的完整路径，含组织协作模式和踩坑经验 | ⭐⭐⭐ |
...
| 4 | [MCP Server Tool 注册中心实践](https://km.sankuai.com/collabpage/2749624013) | 学城 | 美团内部 MCP Server Tool 注册中心的设计与落地，含 Tool 元数据规范、版本管理和权限控制方案 | ⭐⭐⭐ |
| 5 | [MCP 最佳实践架构设计](https://mcp-docs.cn/docs/best-practices/architecture) | 外部 | MCP 中文站整理的架构设计最佳实践，覆盖 Server 分层、错误处理、并发控制和生产环境部署模式 | ⭐⭐⭐ |
| 6 | [Microsoft MCP Case Study](https://github.com/microsoft/mcp-case-study) | 外部 | 微软将 MCP 集成到 GitHub Copilot 和 Azure AI 的完整案例，含架构图、性能数据和迁移路径 | ⭐⭐ |
| 7 | [FRIDAY MCP-Hub 接入手册](https://km.sankuai.com/collabpage/2713327163) | 学城 | 美团 FRIDAY 平台 MCP-Hub 的完整接入文档，含注册流程、调试工具和常见问题，内部接入必读 | ⭐⭐⭐ |
| 8 | [MCP 鉴权指南](https://km.sankuai.com/collabpage/2749624013) | 学城 | 美团内部 MCP 鉴权方案全解，覆盖 OAuth 2.0、API Key、SSO 三种模式的选型与实现，含安全审计要点 | ⭐⭐⭐ |
...
| 5 | [MCP 开发避坑指南](https://www.infoq.cn/article/mcp-development-pitfalls) | 外部 | InfoQ 整理的 MCP 开发高频踩坑：Tool 描述歧义、并发竞态、超时处理、版本兼容，每条附解决方案 | ⭐⭐⭐ |
| 6 | [MCP 踩坑：HTTPS 万能胶](https://cloud.tencent.com/developer/article/2614919) | 外部 | 腾讯云开发者实战记录，专讲 MCP over HTTPS 的证书、跨域、代理等配置坑，附可复用的排查 Checklist | ⭐⭐ |
...
| 7 | [大模型落地选型指南：CLI / MCP / Skills 怎么选](https://blog.csdn.net/weixin_44648216/article/details/147000000) | 外部 | CSDN 技术博客，系统梳理 CLI、MCP、Skills 三种大模型能力扩展方式的适用场景与选型决策树 | ⭐⭐ |
...
| 概念扫盲 | 9 篇 | 4 篇 | 5 篇 |
| 产品决策 | 12 篇 | 6 篇 | 6 篇 |
| 落地实践 | 15 篇 | 7 篇 | 8 篇（含 GitHub） |
| 踩坑排障 | 11 篇 | 4 篇 | 7 篇 |
| 延伸阅读 | 7 篇 | 4 篇 | 3 篇 |
| **合计** | **54 篇** | **25 篇（46%）** | **29 篇（54%）** |
| **合计** | **54 篇** | **25 篇（46%）** | **29 篇（54%）** |
